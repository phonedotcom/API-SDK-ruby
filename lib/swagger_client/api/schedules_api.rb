  ...
  class SchedulesApi
    ...
    def get_account_schedule_with_http_info(account_id, schedule_id, opts = {})
      ...
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling SchedulesApi.get_account_schedule"
      end
      # verify the required parameter 'schedule_id' is set
      if @api_client.config.client_side_validation && schedule_id.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_id' when calling SchedulesApi.get_account_schedule"
      end
      # resource path
      local_var_path = "/accounts/{account_id}/schedules/{schedule_id}".sub('{' + 'account_id' + '}', account_id.to_s).sub('{' + 'schedule_id' + '}', schedule_id.to_s)
    ...
    def list_account_schedules_with_http_info(account_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling SchedulesApi.list_account_schedules"
      end
      ...
      # resource path
      local_var_path = "/accounts/{account_id}/schedules".sub('{' + 'account_id' + '}', account_id.to_s)
